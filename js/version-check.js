...
async function checkForUpdates() {
    try {
        ...
        let latestVersion;
        const VERSION_URL = {
            PROXY: 'https://raw.ihtw.moe/raw.githubusercontent.com/Cedric6work/TVS1/main/VERSION.txt',
            DIRECT: 'https://raw.githubusercontent.com/Cedric6work/TVS1/main/VERSION.txt'
        };
            ...
            setTimeout(() => {
                ...
                if (updateBtn) {
                    updateBtn.addEventListener('click', () => {
                        window.open('https://github.com/Cedric6work/TVS1', '_blank');
                    });
                }
            }, 100);
        } else {
